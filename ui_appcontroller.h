/********************************************************************************
** Form generated from reading UI file 'appcontroller.ui'
**
...
#ifndef UI_APPCONTROLLER_H
#define UI_APPCONTROLLER_H
...
public:
    ...
    void setupUi(QDialog *AppController)
    {
        if (AppController->objectName().isEmpty())
            AppController->setObjectName(QString::fromUtf8("AppController"));
        AppController->resize(420, 427);
        QSizePolicy sizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(AppController->sizePolicy().hasHeightForWidth());
        AppController->setSizePolicy(sizePolicy);
        AppController->setSizeGripEnabled(true);
        widget = new QWidget(AppController);
        widget->setObjectName(QString::fromUtf8("widget"));
        widget->setGeometry(QRect(0, 0, 611, 481));
        ...
        retranslateUi(AppController);

        tabWidget->setCurrentIndex(0);


        QMetaObject::connectSlotsByName(AppController);
    } // setupUi

    void retranslateUi(QDialog *AppController)
    {
        AppController->setWindowTitle(QCoreApplication::translate("AppController", "Dialog", nullptr));
        label->setText(QCoreApplication::translate("AppController", "Input audio device", nullptr));
        labelVideoFPS->setText(QCoreApplication::translate("AppController", "Video FPS", nullptr));
        radioButtonFPS24->setText(QCoreApplication::translate("AppController", "24", nullptr));
        radioButtonFPS30->setText(QCoreApplication::translate("AppController", "30", nullptr));
        radioButtonFPS60->setText(QCoreApplication::translate("AppController", "60", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(SettingTab), QCoreApplication::translate("AppController", "Setting", nullptr));
        recordControlButton->setText(QCoreApplication::translate("AppController", "Start Recording", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(RecordTab), QCoreApplication::translate("AppController", "Screen Record", nullptr));
    } // retranslateUi

};

namespace Ui {
    class AppController: public Ui_AppController {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_APPCONTROLLER_H
